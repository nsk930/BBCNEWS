...
.btn-twitter {
 ...
 <body>
    <div id="topbar">
	 <a href="index.php"><img id="logo" src="images/BBC-logo.jpg">  </a>
    <div id="signin-div" class="topbar-section">
       <img id="signin-image" src="images/signinimage.jpg">
	   <a href="index.php"><span id="Signin-text">Home</span> </a>
	</div> 
	<div id="bell-div">
...
<?php  endif ?>
    ...
    <div class="form-group input-group">
        ...
        <input name="cpass" class="form-control" placeholder="Repeat password" type="password" required>
    </div> <!-- form-group// -->                                      

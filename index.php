...
<head>
 ...
 <body>
   ...
   <div class="clear"></div>
	...
	<div>
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="height:400px; width:1100px">
  ...
  <div class="carousel-inner" style="height:400px; width:1100px">
    <div class="carousel-item active">
      <img class="d-block w-100" src="images/news.jpg" alt="First slide">
	...
	<div class="carousel-item">
      <img class="d-block w-100" src="images/wcc.jpg" alt="fourth slide">
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
	...
	while($row = $stmt->fetch(PDO::FETCH_ASSOC))
	{
	    ...
	    <h2><a href=""><?php echo "{$news_type}";?></a></h2>
     <div id="article-container">		
		<div id="highlight"><a href=""><?php echo "{$news_title}";?>
		</div></a><hr><br><br>
		<div class="col-md-6" id="article-summary">
		<p><?php 
		echo "{$news_description}"?></p></p>
